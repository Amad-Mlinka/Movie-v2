...
export const Header = () => {
    ...
    useEffect(() => {
        setOpenSearch(false);
        sessionStorage.setItem("mediaType",state.mediaType === "tv" ? "tv" : "movie" );
        sessionStorage.setItem("term",state.searchTerm);
    }, [])
    ...
    const onChangeTerm = (changedTerm: string) => {
        ...
        sessionStorage.setItem("term",changedTerm);
    }
            ...
            <div className="header-container">
                ...
                <div className="search">
                    <div className="search-container">
                        ...
                        <input onChange={(e) => onChangeTerm(e.target.value)} value={sessionStorage.getItem("term") || ""} type="search" className="search-input" name="" id="" />
                    </div>
                </div>
                ...
                <div className="filter">
                    <div className="switch">
                        ...
                        <Switch
                            checked={sessionStorage.getItem("mediaType") === "tv" ? false : true}
