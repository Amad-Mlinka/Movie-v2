...
export const DetailPage = () => {
    ...
    const [simillar, setSimillar] = useState<tvInterface[] | movieInterface[]>([])
    ...
    useEffect(() => {
        ...
        fetch(`https://api.themoviedb.org/3/${params.media}/${params.id}/videos?api_key=70846ae2c3bdf81734c4dc36fab283cc&language=en-US`)
            .then(res => res.json())
            .then(data => {
                console.log(typeof data.results[0].key)
                setEmbed(data.results[0].key)
        ...
        fetch(`http://api.themoviedb.org/3/${params.media}/${params.id}/similar?api_key=70846ae2c3bdf81734c4dc36fab283cc&language=en-US`)
            ...
            .then(data => {
                ...
                setSimillar(data.results.slice(0,4))
                                    ...
                                    tv != null && (
                                        <>
                                            <div className="poster-info">
                                                ...
                                                <div className="similar">
                                                    <h1>Simillar {params.media === "tv" ? "TV Shows" : "Movies"}</h1>
                                                    <div className="similar-container">
                                                        <img className="similar-img"></img>
                                                        <img className="similar-img"></img>
                                                        <img className="similar-img"></img>
